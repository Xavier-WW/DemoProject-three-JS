  ...
  [8],
  {
    ...
    110: function (e, t, A) {
      ...
      var a = A(1),
        ...
        r = A(69),
        o = A(72),
        l = A.p + 'static/media/slice-background.c4c219f7.jpg',
        d = A.p + 'static/media/slice-background-large.22249c10.jpg',
        j = A(83),
        g = A(84),
        h = A(85),
        p = A.p + 'static/media/slice-sidebar-layers.f0e4c510.png',
        b = A.p + 'static/media/slice-sidebar-layers-large.d92d7306.png',
        m = A.p + 'static/media/slice-sidebar-annotations.56266a25.png',
        u = A.p + 'static/media/slice-sidebar-annotations-large.5c5a97a4.png',
        E = A.p + 'static/media/slice-slides.9e3633a1.jpg',
        O = A.p + 'static/media/slice-slides-large.ef552f7d.jpg',
        x = A.p + 'static/media/slice-background-bar.1e0c6b9c.jpg',
        w = A.p + 'static/media/slice-background-bar-large.c2adcc51.jpg',
        f = A.p + 'static/media/slice-annotation.1bc3729c.png',
        B = A.p + 'static/media/slice-annotation-large.a2ac9ef6.png',
        v = A(27),
        Q = A(2);
      A(100);
      const M = 'Biomedical image collaboration',
        N =
          'This project involved designing a better way for biomedical educators and learners to annotate digital slides together.',
        D = ['User Research', 'UX Design', 'Interface Design'];
      t.default = () => (
        Object(n.k)(),
        Object(a.jsxs)(s.Fragment, {
          children: [
            Object(a.jsxs)(i.a, {
              children: [
                Object(a.jsx)('title', { children: `Projects | ${M}` }),
                Object(a.jsx)('meta', { name: 'description', content: N }),
              ],
            }),
            Object(a.jsxs)(o.b, {
              className: 'slice',
              children: [
                ...
                Object(a.jsx)(o.c, {
                  ...
                  description: N,
                  url:
                    'https://www.best.edu.au/s/q2yjjvl7?data=8%404!9%4020303!10%40-15087&version=1',
                  roles: D,
                }),
                Object(a.jsx)(o.e, {
                  first: !0,
                  children: Object(a.jsx)(o.g, {
                    children: Object(a.jsx)(o.d, {
                      srcSet: `${j.a} 800w, ${g.a} 1920w`,
                      placeholder: h.a,
                      alt:
                        'The Slice web application showing a selected user annotation.',
                      sizes: `(max-width: ${Q.a.mobile}px) 100vw, (max-width: ${Q.a.tablet}px) 90vw, 80vw`,
                    }),
                  }),
                }),
                Object(a.jsx)(o.e, {
                  children: Object(a.jsxs)(o.f, {
                    centered: !0,
                    className: 'slice__columns',
                    children: [
                      Object(a.jsxs)('div', {
                        className: 'sidebar__images-text',
                        children: [
                          Object(a.jsx)(o.h, { children: 'Bringing it together' }),
                          Object(a.jsx)(o.i, {
                            children:
                ...
                Object(a.jsx)(o.e, {
                  light: !0,
                  children: Object(a.jsxs)(o.g, {
                    children: [
                      Object(a.jsxs)(o.j, {
                        children: [
                          Object(a.jsx)(o.h, { children: 'Improving the experience' }),
                          Object(a.jsx)(o.i, {
                            children:
                ...
                Object(a.jsx)(o.e, {
                  children: Object(a.jsxs)(o.g, {
                    className: 'slice__grid',
                    children: [
                      Object(a.jsxs)('div', {
                        className: 'slice__grid-image',
                        children: [
                          Object(a.jsx)('div', {
                            className: 'slice__grid-background',
                            children: Object(a.jsx)(c.a, {
                              srcSet: `${x} 400w, ${w} 898w`,
                              placeholder:
    ...
    58: function (e, t, A) {
      ...
      t.a = ({
        ...
        const j = Math.min(Math.max(t, 0), 4),
          g = A || `h${Math.max(j, 1)}`;
    ...
    61: function (e, t, A) {
      ...
      const n = Object(
        s.forwardRef
      )(({ as: e = 'div', children: t, className: A, ...s }, i) =>
        Object(a.jsx)(e, { className: c()('section', A), ref: i, ...s, children: t })
      );
      t.a = n;
    },
    62: function (e, t, A) {},
    63: function (e, t, A) {
      ...
      const u = ({
        ...
        const B = Object(n.h)(),
          [v, Q] = Object(s.useState)(!0),
          [M, N] = Object(s.useState)(!B),
          [D, y] = Object(s.useState)(!1),
          [k, C] = Object(s.useState)(!1),
          [P, S] = Object(s.useState)(!1),
          [R, U] = Object(s.useState)(),
          [I, z] = Object(s.useState)(),
          T = Object(s.useRef)(),
          L = Object(s.useRef)(),
          J = null === E || void 0 === E ? void 0 : E.endsWith('.mp4'),
          G = E || (null === i || void 0 === i ? void 0 : i.split(' ')[0]),
          F = !j.a && A;
        Object(s.useEffect)(() => {
          const e = () => {
              Q(!1);
          ...
          Object(s.useEffect)(() => {
            ...
            e && t && U({ width: e, height: t });
          }, []),
          Object(s.useEffect)(() => {
            L.current &&
              I &&
              (x && A
                ? !A || B || j.a || (N(!0), L.current.play())
                : (N(!1), L.current.pause()));
          }, [A, x, B, I]);
        const _ = e => {
            e.preventDefault(),
              L.current.paused ? (N(!0), L.current.play()) : (N(!1), L.current.pause());
          },
          H = () => {
            y(!0), S(!0);
          };
        return Object(a.jsxs)('div', {
          className: c()('image__element-wrapper', {
          ...
          onMouseOver: J
            ...
            : void 0,
          onMouseOut: J ? () => C(!1) : void 0,
          style: { '--delay': Object(h.c)(u + 1e3) },
          children: [
            J &&
              Object(a.jsxs)(s.Fragment, {
                children: [
                  Object(a.jsx)('video', {
                    ...
                    loop: !0,
                    playsInline: !0,
                    className: c()('image__element', { 'image__element--loaded': t }),
                    autoPlay: !B,
                    role: 'img',
                    onLoadStart: e,
                    src: I,
                  ...
                  Object(a.jsx)(l.a, {
                    ...
                    onExit: d.b,
                    onExited: () => y(!1),
                    timeout: { enter: 0, exit: Object(h.b)(g.b.base.durationS) },
                    children: e =>
                      Object(a.jsx)(m.a, {
                        visible: D,
                        children: Object(a.jsxs)(r.a, {
                          className: c()('image__button', `image__button--${e}`),
                          onFocus: H,
                          onBlur: () => S(!1),
                          onClick: _,
                          children: [
                            Object(a.jsx)(o.a, { icon: M ? 'pause' : 'play' }),
                            M ? 'Pause' : 'Play',
                          ],
                        }),
                      }),
            ...
            v &&
              Object(a.jsx)('img', {
                'aria-hidden': !0,
                className: c()('image__placeholder', { 'image__placeholder--loaded': t }),
                style: { '--delay': Object(h.c)(u) },
                ref: T,
                src: b,
                onLoad: e => {
      ...
      t.a = ({
        ...
        const [d, j] = Object(s.useState)(!1),
          { themeId: g } = Object(b.c)(),
          p = Object(s.useRef)(),
          m = Object(n.d)(p, !(null === o || void 0 === o ? void 0 : o.endsWith('.mp4'))),
          E = Object(s.useCallback)(() => {
            j(!0);
          }, []);
        return Object(a.jsx)('div', {
          className: c()('image', e, `image--${g}`, {
            'image--in-viewport': m,
            'image--reveal': A,
            'image--raised': r,
          }),
    ...
    65: function (e, t, A) {
      'use strict';
      async function a({ src: e, srcSet: t, sizes: A }) {
        return new Promise((a, s) => {
          try {
            if (!e && !t) throw new Error('No image src or srcSet provided');
            const s = new Image();
            e && (s.src = e), t && (s.srcset = t), A && (s.sizes = A);
            const i = () => {
    ...
    66: function (e, t, A) {
      ...
      t.a = ({
        ...
        const g = r.includes(null === l || void 0 === l ? void 0 : l.split('.').pop()),
          h =
            (null === l || void 0 === l ? void 0 : l.includes('://')) ||
            '#' === (null === l || void 0 === l ? void 0 : l[0]) ||
            g,
          p = e || (h ? 'noreferrer noopener' : void 0),
          b = t || (h ? '_blank' : void 0),
          m = d || (h ? 'a' : s.b);
        return Object(a.jsx)(m, {
          className: c()('link', o, { 'link--secondary': i }),
          rel: p,
          href: h ? l : void 0,
          to: h ? void 0 : l,
          target: b,
    ...
    72: function (e, t, A) {
      ...
      function p({
        ...
        return Object(a.jsx)(d.a, {
          className: c()('project__header', n),
          children: Object(a.jsxs)('div', {
            className: 'project__header-content',
            style: { '--initDelay': Object(j.c)(300) },
            children: [
              Object(a.jsxs)('div', {
                className: 'project__details',
                children: [
                  Object(a.jsx)(g.a, {
                    className: c()('project__title', { 'project__title--entered': !l.a }),
                    level: 2,
                    as: 'h1',
                    children: e,
                  }),
                  ...
                  !!s &&
                    Object(a.jsx)(r.a, {
                      secondary: !0,
                      iconHoverShift: !0,
                      className: c()('project__link-button', {
                    ...
                    null === i || void 0 === i
                      ...
                      : i.map((e, t) =>
                          Object(a.jsx)(
                            'li',
                            {
                              className: c()('project__meta-item', {
                                'project__meta-item--entered': !l.a,
                              }),
                              style: { '--delay': Object(j.c)(600 + 140 * t) },
      ...
      const b = ({ className: e, ...t }) =>
          Object(a.jsx)('article', { className: c()('project', e), ...t }),
        m = Object(s.forwardRef)(
          (
            {
              className: e,
              light: t,
            ...
            Object(a.jsxs)('section', {
              className: c()('project__section', e, {
                'project__section--light': t,
                'project__section--full-height': s,
              }),
              ref: l,
              ...o,
              children: [
                ...
                Object(a.jsx)(d.a, {
                  className: c()('project__section-inner', {
        ...
        u = ({ opacity: e = 0.7, className: t, entered: A, ...s }) => {
          const i = Object(o.g)(0.6);
          return Object(a.jsxs)('div', {
            className: c()('project__background-image', t, {
              'project__background-image--entered': A,
            }),
            children: [
              Object(a.jsx)('div', {
                className: 'project__background-image-element',
                style: { '--offset': Object(j.d)(i) },
                children: Object(a.jsx)(n.a, { alt: '', role: 'presentation', ...s }),
              }),
              Object(a.jsx)('div', {
        ...
        E = ({ className: e, ...t }) =>
          Object(a.jsx)('div', {
            className: c()('project__image', e),
            children: Object(a.jsx)(n.a, { reveal: !0, delay: 300, ...t }),
          }),
        O = ({ className: e, width: t = 'l', ...A }) =>
          Object(a.jsx)('div', {
            className: c()(
        ...
        x = ({ className: e, level: t = 3, as: A = 'h2', ...s }) =>
          Object(a.jsx)(g.a, {
            className: c()('project__section-heading', e),
            as: A,
            level: t,
            align: 'auto',
            ...s,
        ...
        w = ({ className: e, ...t }) =>
          Object(a.jsx)(h.a, {
            className: c()('project__section-text', e),
            size: 'l',
            ...t,
          }),
        f = ({
          ...
          Object(a.jsx)('div', {
            className: c()(
              ...
              n,
              {
                ...
                'project__text-row--center-mobile': r,
                'project__text-row--no-margin': i,
              }
            ),
            ...o,
          }),
        B = ({ className: e, centered: t, ...A }) =>
          Object(a.jsx)(O, {
            className: c()(
    ...
    83: function (e, t, A) {
      'use strict';
      t.a = A.p + 'static/media/slice-app.091155c4.jpg';
    },
    84: function (e, t, A) {
      'use strict';
      t.a = A.p + 'static/media/slice-app-large.a6491733.jpg';
    },
    85: function (e, t, A) {
      'use strict';
      t.a =
...
//# sourceMappingURL=8.c5c7b6a7.chunk.js.map
