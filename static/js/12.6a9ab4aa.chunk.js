  ...
  [12],
  {
    ...
    114: function (e, t, a) {
      ...
      var A = a(1),
        ...
        i = a(21),
        l = a(75),
        g = a.p + 'static/media/notfound.ced869d1.mp4',
        d = a(22),
        p = a(58),
        h = a(59);
      a(102);
      t.default = function () {
        return Object(A.jsxs)('section', {
          ...
          children: [
            Object(A.jsxs)(r.a, {
              children: [
                Object(A.jsx)('title', { tag: 'title', children: '404 | Not Found' }),
                Object(A.jsx)('meta', {
                  name: 'description',
                  content: "404 page not found. This page doesn't exist",
                }),
              ],
            }),
            Object(A.jsx)(o.a, {
              ...
              onEnter: d.b,
              children: e =>
                Object(A.jsxs)(n.Fragment, {
                  children: [
                    Object(A.jsx)('div', {
                      className: 'page-404__details',
                      children: Object(A.jsxs)('div', {
                        className: 'page-404__text',
                        children: [
                          Object(A.jsx)(p.a, {
                            className: s()('page-404__title', `page-404__title--${e}`),
                            level: 0,
                            children: '404',
                          }),
                          Object(A.jsx)(p.a, {
                          ...
                          Object(A.jsx)(h.a, {
                            className: s()(
                              ...
                              `page-404__description--${e}`
                            ),
                            children:
                              'This page could not be found. It either doesn\u2019t exist or was deleted. Or perhaps we don\u2019t exist at all.',
                          }),
                          Object(A.jsx)(i.a, {
                            secondary: !0,
                            iconHoverShift: !0,
                            className: s()('page-404__button', `page-404__button--${e}`),
                            href: '/',
                            icon: 'chevronRight',
                    ...
                    Object(A.jsxs)('div', {
                      ...
                      children: [
                        Object(A.jsx)('video', {
                          ...
                          loop: !0,
                          playsInline: !0,
                          className: s()('page-404__video', `page-404__video--${e}`),
                          poster:
                        ...
                        Object(A.jsx)('a', {
                          className: s()('page-404__credit', `page-404__credit--${e}`),
                          href: 'https://twitter.com/ruinergame',
                          target: '_blank',
                          rel: 'noopener noreferrer',
                          children: 'Animation from Ruiner',
                        }),
                      ],
                    }),
                  ],
    ...
    58: function (e, t, a) {
      ...
      t.a = ({
        ...
        const d = Math.min(Math.max(t, 0), 4),
          p = a || `h${Math.max(d, 1)}`;
        return Object(A.jsxs)(n.Fragment, {
          children: [
            'bold' === i &&
              Object(A.jsxs)(o.a, {
                children: [
    ...
    75: function (e, t, a) {
      ...
      const g = [
        ...
        d = 'glyph',
        p = 'value';
      const h = ({ text: e, start: t = !0, delay: a = 0, className: c, ...h }) => {
        const j = Object(n.useRef)([{ type: d, value: '' }]),
          u = Object(n.useRef)(),
          m = Object(o.h)();
        return (
          Object(n.useEffect)(() => {
            ...
            const s = () => {
              ...
              o = Object(r.g)(0, e => {
                (j.current = (function (e, t, a) {
                  return e.map((e, A) => {
                    if (A < a) return { type: p, value: e };
                    if (a % 1 < 0.5) {
                      const e = Math.floor(Math.random() * g.length);
                      return { type: d, value: g[e] };
                    }
                    return { type: d, value: t[A].value };
                  });
                })(n, j.current, e)),
                  s();
              });
            return (
              !t ||
                ...
                (c = Object(r.a)(
                  Object(r.b)(a),
                  Object(r.e)({ from: 0, to: n.length, stiffness: 8, damping: 5 })
                ).start(o)),
              m && ((j.current = n.map((e, t) => ({ type: p, value: n[t] }))), s()),
              () => {
                c && c.stop();
              }
            );
          ...
          Object(A.jsxs)('span', {
            className: s()('decoder-text', c),
            ...h,
            children: [
              Object(A.jsx)(i.a, { className: 'decoder-text__label', children: e }),
              Object(A.jsx)('span', {
                'aria-hidden': !0,
...
//# sourceMappingURL=12.6a9ab4aa.chunk.js.map
